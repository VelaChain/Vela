...
import VelaChainVelaVelaChainVelaMarket from './VelaChain/vela/VelaChain.vela.market'
...
export default { 
  VelaChainVelaVelaChainVelaMarket: load(VelaChainVelaVelaChainVelaMarket, 'VelaChain.vela.market'),
